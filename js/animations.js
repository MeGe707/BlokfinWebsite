...
function animation () {
  ...
  t1.fromTo(".card-1-image-1", 1, {x: "-7rem", y: "10rem", opacity: 0}, {x: "0rem", y: "0rem", opacity:1 }, "-=2");
  t1.fromTo(".card-1-image-2", 1, {x: "-7rem", y: "10rem", opacity: 0}, {x: "0rem", y: "0rem", opacity:1 }, "-=2");
  t1.fromTo(".card-1-image-3", 1, {x: "-7rem", y: "10rem", opacity: 0}, {x: "0rem", y: "0rem", opacity:1 }, "-=2");
